...
// Assembly: Microsoft.AspNetCore.Hosting, Microsoft.AspNetCore.Hosting.Abstractions, Microsoft.AspNetCore.Server.IIS, Microsoft.AspNetCore.Server.IISIntegration, Microsoft.AspNetCore.Server.Kestrel, Microsoft.AspNetCore.Server.Kestrel.Core, Microsoft.AspNetCore.Server.Kestrel.Transport.NamedPipes, Microsoft.AspNetCore.Server.Kestrel.Transport.Quic, Microsoft.AspNetCore.Server.Kestrel.Transport.Sockets
...
export interface IStartupConfigureContainerFilter_1$instance<TContainerBuilder extends unknown> {
...
export type IStartupConfigureContainerFilter_1<TContainerBuilder extends unknown> = IStartupConfigureContainerFilter_1$instance<TContainerBuilder>;
...
export const StartupBase_1: (abstract new<TBuilder extends unknown>(factory: IServiceProviderFactory_1<TBuilder>) => StartupBase_1<TBuilder>) & {
};


export interface __StartupBase_1$views<TBuilder extends unknown> {
    As_IStartup(): IStartup$instance;
}
...
export abstract class WebHostBuilderExtensions$instance {
    ...
    static UseStartup<TStartup extends (object | null)>(hostBuilder: IWebHostBuilder, startupFactory: Func_2<WebHostBuilderContext, TStartup>): IWebHostBuilder;
    static UseStartup(hostBuilder: IWebHostBuilder, startupType: Type): IWebHostBuilder;
    static UseStartup<TStartup extends (object | null)>(hostBuilder: IWebHostBuilder): IWebHostBuilder;
