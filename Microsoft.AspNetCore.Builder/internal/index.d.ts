...
export abstract class ControllerEndpointRouteBuilderExtensions$instance {
    static MapAreaControllerRoute(endpoints: IEndpointRouteBuilder, name: string, areaName: string, pattern: string, defaults?: unknown | null, constraints?: unknown | null, dataTokens?: unknown | null): ControllerActionEndpointConventionBuilder;
...
export abstract class MapRouteRouteBuilderExtensions$instance {
    static MapRoute(routeBuilder: IRouteBuilder, name: string | null, template: string | null, defaults: unknown | null, constraints: unknown | null, dataTokens: unknown | null): IRouteBuilder;
    static MapRoute(routeBuilder: IRouteBuilder, name: string | null, template: string | null, defaults: unknown | null, constraints: unknown | null): IRouteBuilder;
    static MapRoute(routeBuilder: IRouteBuilder, name: string | null, template: string | null, defaults: unknown | null): IRouteBuilder;
...
export abstract class MvcAreaRouteBuilderExtensions$instance {
    static MapAreaRoute(routeBuilder: IRouteBuilder, name: string, areaName: string, template: string | null, defaults: unknown | null, constraints: unknown | null, dataTokens: unknown | null): IRouteBuilder;
    static MapAreaRoute(routeBuilder: IRouteBuilder, name: string, areaName: string, template: string | null, defaults: unknown | null, constraints: unknown | null): IRouteBuilder;
    static MapAreaRoute(routeBuilder: IRouteBuilder, name: string, areaName: string, template: string | null, defaults: unknown | null): IRouteBuilder;
...
export abstract class RazorComponentsEndpointRouteBuilderExtensions$instance {
    static MapRazorComponents<TRootComponent extends unknown>(endpoints: IEndpointRouteBuilder): RazorComponentsEndpointConventionBuilder;
}
...
export abstract class UseMiddlewareExtensions$instance {
    static UseMiddleware<TMiddleware extends unknown>(app: IApplicationBuilder, ...args: (unknown | null)[]): IApplicationBuilder;
    static UseMiddleware(app: IApplicationBuilder, middleware: Type, ...args: (unknown | null)[]): IApplicationBuilder;
}
